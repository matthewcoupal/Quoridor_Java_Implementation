...
public class GameMenu {
  ...
  /**
   * Creates the demo screen for the game.
   */
...
class NumbButton extends JButton {
  ...
  private Color[] bckgrndColor = new Color[] {Color.RED /* 0 */, Color.ORANGE /* 1 */,
      Color.YELLOW /* 2 */, Color.GREEN /* 3 */, Color.CYAN /* 4 */, Color.MAGENTA /* 5 */,
      Color.BLACK, /* 6 */
      new Color(150, 75, 0)/* 7 BROWN */, Color.LIGHT_GRAY/* 8 */, Color.WHITE /* 9 */
  };
