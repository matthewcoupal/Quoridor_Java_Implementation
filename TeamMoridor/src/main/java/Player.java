...
/**
 * Emulates a player on the board by utilizing the same information as a space, but with extra
...
public class Player extends Space implements PlayerInterface {
   ...
   * @param wallstoStart The number of walls the players starts the game with
   */
  ...
  /**
   * Setter for specifying the number of walls the player has left to use.
   * 
   * @param numberOfWalls The specified number of walls left.
   */
